...
variable "aws_vpc_azs" {
  type        = list(string)
  description = "Add list of AZs available in the region that you want to use. Example ['ap-southeast-1a', 'ap-southeast-1b', 'ap-southeast-1c']"
...
variable "aws_ecs_cluster_name" {
  ...
  default     = "node-ecs-cluster"
}

variable "aws_ecr_repository" {
  type        = string
  description = "ECR repo name"
  default     = "node_ecs_app"
}

variable "aws_ecs_task_def_fam" {
  type        = string
  description = "node_ecs_fam"
  default     = "node_ecs_fam"
}
